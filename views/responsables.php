...
<nav class="navbar navbar-expand-lg navbar-dark mb-4">
    <div class="container">
        ...
        <div class="d-flex">
            ...
            <a href="/contabilidad" class="btn btn-outline-light me-2">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    <span id="modalTitle">Nuevo Responsable</span>
                </h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="guardarResponsable">
